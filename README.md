...
[`accounting-excel-toolkit`](https://github.com/ryanduguid/SirAlexanderFitzgerald): Power Query parsers for the manual-export path, when API access isn't on the table.
